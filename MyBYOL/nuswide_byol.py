...
import os
from util import NuswideClassification, save_checkpoint, wbin_pkl, get_all_filename
...
def main_mirflickr25k():
	...
	train_dataset = NuswideClassification(args.data, 'train', )
	val_dataset = NuswideClassification(args.data, 'test', )
